...
<h2><p style="margin-left: 20px;">Novel</p></h2>
 ...
 <div class="Recommend">
	 ...
	 <?php
					 $a="SELECT * from books WHERE book_type = 'Novel';";

										 if($result=$conn->query($a)){
										 while ($row=$result->fetch_array()){
                     echo "<a href='addbestbook.php?bestid=".$bestbookid."&bookid=".$row['book_id']."&booktype=$booktype'>";
...
<h2><p style="margin-left: 20px;">Comic</p></h2>
 ...
 <div class="Recommend">
	 ...
	 <?php
					 $a="SELECT * from books WHERE book_type = 'Comic';";
           if($result=$conn->query($a)){
           while ($row=$result->fetch_array()){
           echo "<a href='addbestbook.php?bestid=".$bestbookid."&bookid=".$row['book_id']."&booktype=$booktype'>";
           echo "<div class='product'>";
