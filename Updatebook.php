...
<div class="content2">
 <div class="main2">
  <div class="box">
    <h2><p style="margin-left: 20px;">UpdateBook</p></h2>
     <hr>
     <?php
     ...
     if(isset($_GET['userid'])){$userid=$_GET['userid'];}
     	$a = "select * from books where book_id='".$userid."';";
      if($userid!=''){
     ...
     ?>
     <form action="UpdateBook.php" method="post" enctype="multipart/form-data" style="width:50px; margin-left:40%;" >

       <label style="margin-bottom:20px; margin-right:20px; font-weight:bold;">Bookname:</label>
       <input style="margin-bottom:20px; "type="text" name="bookname" value="<?php echo $bookname;  ?>"/><br>
       <label style="margin-bottom:20px;  margin-right:26px; font-weight:bold;">Booktype:</label>
       <input style="margin-bottom:20px; "type="text" name="booktype" value="<?php echo $booktype;  ?>"/><br>
       <label style="margin-bottom:20px;  margin-right:24px;font-weight:bold;">Bookprice:</label>
       <input style="margin-bottom:20px;"type="text" name="bookprice" value="<?php echo $bookprice;  ?>" /><br>
       <input type="hidden" value="<?php echo $bookid;?>" name="bookid">
       <button style="width:180px;background-color:#41AD49;" class="w3-btn" type="submit" name="upbooksub" >SUBMIT</button><br>
