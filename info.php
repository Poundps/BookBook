...
<div class="boxinfo" style="margin-top:40px;">
<img style="max-height:100%;max-width:100%;"src="./Phtos/Id.png"/ >
<div style="position:absolute;top:128px; right:180px; font-size:14px; font-weight:bold;">
<?php

echo "<label>".$_SESSION['user_firstname']."&nbsp;".$_SESSION['user_lastname']."<label>"."<br>";
echo "<label>".$_SESSION['user_email']."<label>"."<br>";
echo "0000"."<label>".$_SESSION['user_id']."<label>"."<br>";
echo "<label>".$_SESSION['user_gender']."<label>"."<br>";
echo "<label>".$_SESSION['user_birth']."<label>"."<br>";
echo "<label>".$_SESSION['user_phone']."<label>"."<br>";
