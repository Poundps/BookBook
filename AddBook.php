...
<div class="content2">
 <div class="main2">
  <div class="box">
    <h2><p style="margin-left: 20px;">AddBook</p></h2>
     <hr>
     <form action="AddBook.php" method="post" enctype="multipart/form-data" style="width:50px; margin-left:40%;" >

       <label style="margin-bottom:20px; margin-right:20px; font-weight:bold;">Bookname:</label>
       <input style="margin-bottom:20px; "type="text" name="bookname" /><br>
       <label style="margin-bottom:20px;  margin-right:26px; font-weight:bold;">Booktype:</label>
       <input style="margin-bottom:20px; "type="text" name="booktype" /><br>
       <label style="margin-bottom:20px;  margin-right:24px;font-weight:bold;">Bookprice:</label>
       <input style="margin-bottom:20px;"type="text" name="bookprice" /><br>
       <label style="margin-bottom:20px;  margin-right:30px;font-weight:bold;">Bookimg:</label>
       <input style="margin-bottom:20px;"type="file" name="bookimg" /><br>
       <button style="width:180px;background-color:#41AD49;" class="w3-btn" type="submit" name="booksub" >SUBMIT</button><br>
